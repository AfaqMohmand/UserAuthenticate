...
export const addUserAction = (user) => {
  return (dispatch) => {
    ...
    axios
      .post("https://ti-react-test.herokuapp.com/users", user)
      .then((response) => {
...
export const getUserAction = (id) => {
  return (dispatch) => {
    axios
      .get(`https://ti-react-test.herokuapp.com/users/${id}`)
      .then((response) => {
        console.log(response);
...
export const deleteUserAction = (id) => {
  return (dispatch) => {
    axios
      .delete(`https://ti-react-test.herokuapp.com/users/${id}`)
      .then((response) => {
        console.log(response);
        dispatch(deleteUser());
...
export const updateUserAction = (user, id) => {
  return (dispatch) => {
    axios
      .put(`https://ti-react-test.herokuapp.com/users/${id}`, user)
      .then((response) => {
        console.log(response);
        dispatch(updateUser());
        dispatch(getUsersAction());
